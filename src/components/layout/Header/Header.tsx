        ...
        >
          {publicNavigation.map((item) => (
            <Link
              ...
              className={cn(
                "relative rounded-xl px-3 py-2 text-sm font-medium text-slate-600 transition",
                ...
                isPublicNavigationActive(item, pathname, hash) &&
                  "bg-brand-50 font-semibold text-brand-700 shadow-sm ring-1 ring-brand-100 after:bg-brand-500"
              )}
            >
              {item.label}
            </Link>
