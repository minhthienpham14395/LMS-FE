...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 h-full w-64 bg-gray-50 border-r border-gray-300 sidebar transition-transform ${
          !sidebarOpen ? "-translate-x-full" : ""
        }`}
      >
        <div className="p-8 flex items-center gap-3 border-b border-gray-300">
          <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-cyan-500 rounded-lg flex items-center justify-center font-black text-white">
            B
          </div>
          <div>
            <p className="font-black text-gray-900">BrightKids</p>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-300 space-y-2">
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 cursor-pointer transition-all">
            <HelpCircle size={20} />
            <span className="text-sm font-semibold">Trợ giúp</span>
          </div>
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:text-red-600 hover:bg-red-50 cursor-pointer transition-all">
            <LogOut size={20} />
          ...
          <div className="flex items-center justify-between px-8 py-5">
            <div className="flex items-center gap-4">
              <button
                ...
                className="p-2 hover:bg-gray-100 rounded-lg transition-all text-gray-900"
              >
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="p-2 hover:bg-gray-100 rounded-lg transition-all text-gray-900">
                <Settings size={20} />
              </button>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-100 transition-all text-gray-900"
                >
                  <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-cyan-500 rounded-full flex items-center justify-center font-bold text-white text-sm">
                    A
                  </div>
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 top-12 w-48 glass-effect rounded-xl overflow-hidden z-50">
                    ...
                    <div className="p-2 space-y-1">
                      <div className="px-4 py-2 hover:bg-gray-100 rounded cursor-pointer text-sm text-gray-900">
                        Hồ sơ
                      </div>
                      <div className="px-4 py-2 hover:bg-gray-100 rounded cursor-pointer text-sm text-gray-900">
                        Cài đặt
                      </div>
                      <div className="px-4 py-2 hover:bg-red-50 rounded cursor-pointer text-sm text-red-600">
                        Đăng xuất
                      </div>
                    </div>
                  </div>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {stats.map((stat, idx) => (
              <div
                key={idx}
                className="stat-card glass-effect rounded-2xl p-6 hover:border-teal-400/50 transition-all group"
              >
                ...
                <p className="text-3xl font-black text-gray-900 stat-value">
                  {stat.value}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 glass-effect rounded-2xl p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <select className="bg-gray-100 border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-900 hover:bg-gray-200 transition-all">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 glass-effect rounded-2xl p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-teal-700 hover:text-teal-800 text-sm font-semibold">
                  Xem tất cả →
                </button>
              </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-300">
                      <th className="text-left py-4 px-4 text-xs font-black text-gray-600 uppercase tracking-wider">
                        Khóa học
                      </th>
                      <th className="text-left py-4 px-4 text-xs font-black text-gray-600 uppercase tracking-wider">
                        Học viên
                  ...
                  <tbody>
                    {recentCourses.map((course, idx) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-4 font-semibold text-teal-700 text-sm">
                          {course.revenue}
                        </td>
                        <td className="py-4 px-4">
                ...
                {activities.map((activity, idx) => (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-2">
                      <div className="avatar w-8 h-8 rounded-full flex items-center justify-center font-bold text-white text-xs flex-shrink-0">
                        {activity.avatar}
                      </div>
          ...
          {/* Welcome Banner */}
          <div className="mt-8 bg-gradient-to-r from-cyan-100/40 to-teal-100/40 rounded-2xl p-8 border border-teal-300">
            <div className="flex items-center justify-between">
              ...
              <button className="btn-primary bg-teal-600 hover:bg-teal-700 text-white font-black px-8 py-3 rounded-xl whitespace-nowrap">
                Xem chi tiết
              </button>
            </div>
          </div>
