...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-50 text-gray-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      <style>{`
        @keyframes slideIn {
          from {
      ...
      {/* Background Elements */}
      <div className="absolute w-96 h-96 rounded-full blur-3xl bg-linear-to-br from-cyan-400 to-transparent opacity-15 top-0 right-0 -translate-y-32 translate-x-32 float-circle"></div>
      <div className="absolute w-96 h-96 rounded-full blur-3xl bg-linear-to-br from-cyan-400 to-transparent opacity-10 bottom-0 left-0 -translate-x-32 translate-y-32 pulse-circle"></div>
